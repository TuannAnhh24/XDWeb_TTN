    ...
    <div class="than">
        ...
        <div class="khungcauhoi">
            ...
            <div class="dapan-container">
                ...
                <input type="hidden" name="noidung_dap_an_<?= $soCau ?>"
                    value="<?php echo $noidung['noidung_dap_an'] ?>">
                <?php $dapan_key++; ?>
                <?php endforeach ?>
            </div>
        </div>
        ...
        <div class="dapancuaban">
            ...
            <div class="khungtraloi">
                ...
                <?php
                        ...
                        ?>
                <span class="traloi" data-cau-hoi="<?= $soCau ?>"
                    data-dap-an="<?php echo $hidden_value; ?>"><?php echo $dapan_key; ?></span>
            </div>
            <?php $dapan_key++; ?>
            <?php endforeach ?>
        </div>
...
const duration = 40 * 60; // Thời gian làm bài (15 phút)
